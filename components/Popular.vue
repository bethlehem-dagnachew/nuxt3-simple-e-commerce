<template>
  <div>
    <div class="category-page">
      <h2 class="new_arr">Popular <span class="arrival">Products </span></h2>
      <p class="new_arr-home">
          ...
          <div class="gs-product-card">
            <div class="gs-product-card-content">
              <div class="gs-product-card-image-container">
                <img
                  class="gs-product-card-image"
                  src="@/assets/images/1.jpeg"
                />
              </div>
              <div class="gs-product-card-product-type">New</div>
              <!-- <div class="gs-product-card-save">
                            <div class="new-product">New</div>
                        </div> -->
              <div class="gs-product-card-name">Ethiopian Coffee</div>
              <div class="gs-product-card-detail">
                <div class="gs-product-card-detail-title">Br.200</div>
              </div>
            </div>
          </div>
...
<style  scoped>
@import url("@/assets/css/popular.css");
</style>